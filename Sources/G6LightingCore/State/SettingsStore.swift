...
public final class SettingsStore: ObservableObject {
    ...
    @Published public var isOn: Bool          { didSet { store.setBool(isOn, forKey: Key.isOn) } }
    @Published public var ringLedOn: Bool     { didSet { store.setBool(ringLedOn, forKey: Key.ringLed) } }
    @Published public var red: Int            { didSet { store.setInteger(red, forKey: Key.red) } }
    @Published public var green: Int          { didSet { store.setInteger(green, forKey: Key.green) } }
    @Published public var blue: Int           { didSet { store.setInteger(blue, forKey: Key.blue) } }
    @Published public var brightness: Int     { didSet { store.setInteger(brightness, forKey: Key.brightness) } }
    @Published public var mode: LightingMode  { didSet { store.setString(mode.rawValue, forKey: Key.mode) } }
    @Published public var cycleSpeed: Double  { didSet { store.setDouble(cycleSpeed, forKey: Key.cycleSpeed) } }
    @Published public var breathingSpeed: Double { didSet { store.setDouble(breathingSpeed, forKey: Key.breathingSpeed) } }
