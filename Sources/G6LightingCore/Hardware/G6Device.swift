...
public final class G6Device: Sendable {
    ...
    public static func makeReal() -> G6Device {
    ...
    public func setColor(_ frame: LightingFrame) async throws {
    ...
    public func disableLogo() async throws {
        try await transport.send(reports: [G6Protocol.disablePacket()])
    }

    public func setRingLed(enabled: Bool) async throws {
